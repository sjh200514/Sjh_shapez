...
Q_CONSTINIT static const qt_meta_stringdata_CLASSMainSceneENDCLASS_t qt_meta_stringdata_CLASSMainSceneENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(10, 20),  // "on_btn_start_clicked"
        QT_MOC_LITERAL(31, 0),  // ""
        QT_MOC_LITERAL(32, 7),  // "checked"
        QT_MOC_LITERAL(40, 23)   // "on_btn_continue_clicked"
    },
    "MainScene",
    "on_btn_start_clicked",
    "",
...
Q_CONSTINIT const QMetaObject MainScene::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMainSceneENDCLASS_t,
        ...
        // method 'on_btn_continue_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void MainScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_btn_start_clicked((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 1: _t->on_btn_continue_clicked(); break;
        default: ;
        }
    }
}
